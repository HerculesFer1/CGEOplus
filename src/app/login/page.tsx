  ...
  return (
    <div className="relative flex min-h-screen items-center justify-center bg-[var(--bg)] px-6">
      ...
      >
        ...
        >
          Acesse com sua conta institucional Google
        </motion.p>
        ...
        <motion.div variants={fadeSlideUp} className="mt-8">
          <button
            ...
            disabled={loading}
            className="inline-flex w-full items-center justify-center gap-3 rounded-full border bg-[var(--elevated)] px-5 py-3 text-sm font-medium text-[var(--text)] shadow-[var(--shadow-sm)] transition-all hover:shadow-[var(--shadow-md)] disabled:opacity-60"
          >
            <GoogleIcon />
